...
class PowerUp:
    ...
    PROPERTIES = {
        ...
        'laser': {'color': (255, 60, 60), 'char': 'L', 'message': 'LASER CANNONS (F)'},
        'glue': {'color': (60, 255, 60), 'char': 'C', 'message': 'CATCH PADDLE'},
        'slow': {'color': (255, 165, 0), 'char': 'S', 'message': 'SLOW BALL'},
        'death': {'color': (0, 0, 0), 'char': 'D', 'message': 'YOU CAUGHT YOUR DEATH'},
        'life': {'color': (252, 3, 177), 'char': '+', 'message': 'EXTRA LIFE'},
        'multiball': {'color': (255, 255, 0), 'char': 'M', 'message': 'MULTIBALL'},
    }
